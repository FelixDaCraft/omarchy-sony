...
DAEMON_BIN = os.environ.get("DAEMON_BIN", "/home/roykevin/Projects/omarchy-sony/build/daemon/sony-headphones-daemon")
...
def test_start_stop_cycles(sbox):
    ...
    sock_path = os.path.join(run_dir, "sony-headphones.sock")
    status_path = os.path.join(state_dir, "sony-headphones", "status.json")
...
def main():
    sbox = tempfile.mkdtemp(prefix="omasony_daemon_stress_")
